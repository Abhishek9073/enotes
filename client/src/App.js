...
function App() {
  ...
  const fetchFiles = async () => {
    try {
      const response = await axios.get('https://enotes-five.vercel.app/files');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://enotes-five.vercel.app/upload', formData, {
        headers: {
  ...
  const handleUpdate = async (id) => {
    ...
    try {
      await axios.put(`https://enotes-five.vercel.app/update/${id}`, {
        title: updatedTitle,
  ...
  const handleDelete = async (id) => {
    try {
       await axios.delete(`https://enotes-five.vercel.app/delete/${id}`);
